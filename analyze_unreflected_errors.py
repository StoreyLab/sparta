...
#title = 'RNA-seq Phred Scores vs Actual Mismatch Probability'
...
ax.set_xscale('log')
ax.set_yscale('log')
s1 = ax.scatter(xdata, ydata, color='blue', label='Storey')
#s2 = ax.scatter(xdata2, ydata2, color='r', label='Skelly et al')
#ax.plot(xdata, f_of_x)
ax.plot(xdata, xdata, 'grey')
ax.grid(True)
